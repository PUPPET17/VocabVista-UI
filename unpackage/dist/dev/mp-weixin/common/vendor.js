...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__70E35F1",
    appName: "vocabvista-ui",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const xhrAdapter = isXHRAdapterSupported && function(config) {
  return new Promise(function dispatchXhrRequest(resolve2, reject) {
    ...
    let contentType;
    if (utils$1.isFormData(requestData2)) {
    ...
    requestData2 === void 0 && requestHeaders.setContentType(null);
    ...
    request.send(requestData2 || null);
  });
};
const knownAdapters = {
  http: httpAdapter,
...
const tabBar = {
  ...
  list: [
    ...
    },
    {
      ...
      selectedIconPath: "static/icons/dashboard-selected.png"
    },
    {
      pagePath: "pages/mine",
...
var define_process_env_UNI_STAT_TITLE_JSON_default = { "pages/index": "登录页", "pages/home": "首页", "pages/dashboard": "dashboard", "pages/mine": "我的", "pages/word": "word" };
